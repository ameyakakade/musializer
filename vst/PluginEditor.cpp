...
void shaderC::initialise()
{
    ...
    juce::gl::glTexImage2D(juce::gl::GL_TEXTURE_2D, 0, juce::gl::GL_R32F, textureWidth, 1, 0, juce::gl::GL_RED, juce::gl::GL_FLOAT, nullptr);
...
void shaderC::render()
{
    ...
    shader->setUniform("uRes", (float)getWidth(), (float)getHeight());
